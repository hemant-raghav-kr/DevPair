...
export function ProjectDetail({ project, isOwner }: ProjectDetailProps) {
        ...
        {isOwner && (
          <div className="flex items-center gap-2">
            <Link
              ...
              className="inline-flex items-center gap-1.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 dark:bg-zinc-100 dark:hover:bg-white text-white dark:text-zinc-900 px-4 py-2 text-xs font-semibold shadow-xs transition-colors"
            >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
              Positions currently open for collaboration ({totalSlots} total slot{totalSlots === 1 ? "" : "s"}).
            </p>
          </div>
